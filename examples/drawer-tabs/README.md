...
| -------- | --------- | ------------------------------ | ----------- |
| android  | supported | drawer, tabs.javascript.bottom | none        |
| ios      | supported | drawer, tabs.javascript.bottom | none        |
| web      | supported | drawer, tabs.javascript.bottom | none        |
...
```sh
ankh navigator examples generate --id drawer-tabs --target .
```
