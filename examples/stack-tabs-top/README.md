...
| -------- | --------- | --------------------------------- | ----------- |
| android  | supported | stack.native, tabs.javascript.top | none        |
| ios      | supported | stack.native, tabs.javascript.top | none        |
| web      | supported | stack.native, tabs.javascript.top | none        |
...
```sh
ankh navigator examples generate --id stack-tabs-top --target .
```
