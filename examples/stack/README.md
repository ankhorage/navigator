...
Native Stack routes with a protected destination and modal presentation.
...
| -------- | --------- | ------------ | ----------- |
| android  | supported | stack.native | none        |
| ios      | supported | stack.native | none        |
| web      | supported | stack.native | none        |
...
```sh
ankh navigator examples generate --id stack --target .
```
