...
| -------- | --------- | ---------------------------------- | ----------- |
| android  | supported | stack.native, tabs.headless.bottom | none        |
| ios      | supported | stack.native, tabs.headless.bottom | none        |
| web      | supported | stack.native, tabs.headless.bottom | none        |
...
```sh
ankh navigator examples generate --id tabs-stack --target .
```
