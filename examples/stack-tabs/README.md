...
| -------- | --------- | ------------------------------------ | ----------- |
| android  | supported | stack.native, tabs.javascript.bottom | none        |
| ios      | supported | stack.native, tabs.javascript.bottom | none        |
| web      | supported | stack.native, tabs.javascript.bottom | none        |
...
```sh
ankh navigator examples generate --id stack-tabs --target .
```
